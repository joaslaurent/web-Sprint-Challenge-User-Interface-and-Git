...
Semantic HTML is markup that gives meaning to the webpages and their design.  Meaning using useful divs such as header, nav, menu, section, button, and etc. rather than just divs.
